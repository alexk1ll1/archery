    ...
    <form action="" id="parkourForm">
      <div class="container">
        ...
        <div class="container">
          ...
          <div class="col text-center">
            <div class="col-12">
              <button class="btn btn-primary" type="submit" style="background-color: #099701; border-color: white" id="buttonCreateParkour">Erstellen
              </button>
              <a class="btn btn-primary" href="index.html" style="background-color: #099701; border-color: white" role="button">Zurück</a>
            </div>
          </div>
        </div>
      </div>
